...
<template>
  ...
  >
    <div class="content">
      ...
      <p v-if="gameState === 'waiting'" class="instruction">Chờ màu xanh...</p>

      <p v-if="gameState === 'ready'" class="instruction big">CLICK NGAY!</p>

      <p v-if="gameState === 'result'" class="instruction">Phản xạ của bạn</p>
      ...
      <div v-if="gameState === 'idle'" class="start-area">
        <button class="start-button" @click.stop="startGame">BẮT ĐẦU</button>
      </div>
      ...
      <div v-else-if="gameState === 'result'" class="result-area">
        ...
        <button class="retry-button" @click.stop="startGame">CHƠI LẠI</button>
      </div>

      <div v-else-if="gameState === 'too-early'" class="result-area">
        <div class="error-icon">✕</div>

        <p class="error-text">Hãy đợi màu xanh rồi mới click!</p>

        <button class="retry-button" @click.stop="startGame">THỬ LẠI</button>
      </div>
      ...
      <div v-if="bestTime" class="best">🏆 Best: {{ bestTime }} ms</div>

      <button v-if="bestTime" class="reset" @click.stop="resetBest">
        Xóa kỷ lục
      </button>
    </div>
  </main>
